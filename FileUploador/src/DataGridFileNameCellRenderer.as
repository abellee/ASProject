package {
	 ...
	 * @author Abel Lee
	 */
	public class DataGridFileNameCellRenderer extends UIComponent implements ICellRenderer {
        ...
        public function DataGridFileNameCellRenderer() {
			super();
        }
		...
		{
			super.setSize(v0, v1);
			if(_listData && _listData.index % 2 != 0) colorNum = 0xffffff;
			if(upSkin){
