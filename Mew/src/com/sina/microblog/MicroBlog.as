package com.sina.microblog
{
	...
	public class MicroBlog extends EventDispatcher
	{
		...
		{
			var mbs:MicroBlogStatus = new MicroBlogStatus();
			mbs.init(status);
			return mbs;
		}
		...
		{
			var mbc:MicroBlogComment = new MicroBlogComment();
			mbc.init(comment);
			return mbc;
		}
		...
		private function processCounts(counts:XML):Array
		{
			...
			{
				count=new MicroBlogCount();
				count.init(countValue);
		...
		{
			var mbu:MicroBlogUnread = new MicroBlogUnread();
			mbu.init(data);
			return mbu;
		}
		...
		{
			var mbu:MicroBlogUser = new MicroBlogUser();
			mbu.init(user);
			return mbu;
		}
		...
		{
			var mbdm:MicroBlogDirectMessage = new MicroBlogDirectMessage();
			mbdm.init(message);
			return mbdm;
		}
		...
		{
			var mbur:MicroBlogUsersRelationship = new MicroBlogUsersRelationship();
			mbur.init(message);
			return mbur;
		}
		...
		{
			var mbrl:MicroBlogRateLimit = new MicroBlogRateLimit();
			mbrl.init(message);
			return mbrl;
		}
